...
//
//     final populationApiModel = populationApiModelFromJson(jsonString);

import 'dart:convert';

PopulationApiModel populationApiModelFromJson(String str) =>
    PopulationApiModel.fromJson(json.decode(str));

String populationApiModelToJson(PopulationApiModel data) =>
    json.encode(data.toJson());

class PopulationApiModel {
  List<Datum> data;
  List<Source> source;
  ...
  factory PopulationApiModel.fromJson(Map<String, dynamic> json) =>
      PopulationApiModel(
